                ...
                <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
                    <div>
                        ...
                        <p className="text-[16px] leading-7 font-[700] text-textColor mt-4">
                            Copyright @ {year} Developed by MEHMOOD QADIR All Right Reserved.</p>
                            <div className="flex items-center gap-3 mt-4">
                                {socialLinks.map((link, index) => (
                                <Link to= {link.path} key={index} className="w-9 h-9 border border-solid border-[#181A1E] rounded-full
                                flex items-center justify-center group hover:gb-primaryColor hover:border-none">
                                    {link.icon}
                                </Link>
                                ))}
                            </div>
